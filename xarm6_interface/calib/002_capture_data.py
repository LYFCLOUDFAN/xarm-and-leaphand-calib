...
if __name__ == '__main__':
    ...
    save_data_rel_dir_path = Path('/home/xzx/Dro/third_party/xarm6/data/camera/233622079809')
    init_X_BaseCamera_path = Path('/home/xzx/Dro/third_party/xarm6/data/camera/233622079809/init_X_BaseCamera.npy')
    ...
    while True:
        ...
        if mp_is_success:
            ...
            if verification_state == VerificationState.VERIFIED_NO:
                ...
                verification_state = VerificationState.WAITING_FOR_VERIFICATION
                if len(waypt_joint_values_np) != 0:
                    xarm6_rw.set_joint_values_sequence(waypt_joint_values_np, speed=50, planning_timestep=timestep)
                else:
