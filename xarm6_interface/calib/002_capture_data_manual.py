...
if __name__ == '__main__':
    ...
    ''' params '''
    serial_number='317222073552'#"233622079809"
    exp_name = "0307_excalib_capture00"
    camera_data_path = Path(os.path.join(ROOT_DIR, f"third_party/xarm6/data/camera/{serial_number}"))
    ...
    xarm6_rw = XArm6RealWorld(ip=XARM6_IP)#XARM6_IP
    # setup camera 
