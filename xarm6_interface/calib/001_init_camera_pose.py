...
from loguru import logger as lgr #pip install loguru
...
rotation_matrix = R.from_euler('y', 180, degrees=True).as_matrix() @ R.from_euler('x', 55, degrees=True).as_matrix()
# # left beblow
# rotation_matrix = R.from_euler('z', 180, degrees=True).as_matrix() @R.from_euler('y', 180, degrees=True).as_matrix() @ R.from_euler('x', 90, degrees=True).as_matrix()
...
# X_BaseCamera[0:3, 3] = np.array([0.5, -0.5, 0.2]) #left
...
if __name__ == '__main__':
    ...
    serial_number = '317222073552'  # '241122074374', '317222074181''317222074181' 147122075879 ‘233622079809’
    camera = Realsense(serial_number)
    
    K_path = Path("/home/xzx/Dro/third_party/xarm6/data/camera/317222073552/K.npy")
    save_init_pose_np_path = "/home/xzx/Dro/third_party/xarm6/data/camera/317222073552/init_X_BaseCamera.npy"
